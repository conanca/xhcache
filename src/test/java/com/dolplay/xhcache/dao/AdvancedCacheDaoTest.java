...
public class AdvancedCacheDaoTest {
	private static Logger logger = LoggerFactory
			.getLogger(AdvancedCacheDaoTest.class);
	...
	public static void setUpBeforeClass() throws Exception {
		...
		// 初始化cacheDao
		cacheDao = appContext.getBean("advancedCacheDao",
				AdvancedCacheDao.class);
	}
	...
	public void testZAddStringIntDoubleString() throws Exception {
		...
		assertTrue(jedis.ttl("test:listCba") <= 300
				&& jedis.ttl("test:listCba") > 290);
	...
	public void testZQueryByRankStringLongLongOrder() throws Exception {
		...
		List<String> list = cacheDao.zQueryByRank("test:listMmm", 2, 5,
				Order.Desc);
	...
	public void testZQueryByScoreStringDoubleDoubleOrder() throws Exception {
		...
		List<String> list = cacheDao.zQueryByScore("test:listPpp", 3000, 3999,
				Order.Desc);
	...
	public void testZQueryAllStringOrder() throws Exception {
		...
		assertEquals(Lang.list("888", "777", "666", "555", "444", "333", "222",
				"111"), list);
	}
	...
	public void testZQueryAllString() throws Exception {
		...
		assertEquals(Lang.list("111", "222", "333", "444", "555", "666", "777",
				"888"), list);
	}
