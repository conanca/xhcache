package com.dolplay.xhcache.annotation;
...
/**
 * @author Conanca 指明要进行缓存操作的方法的注解 注:方法还需要声明@Aop("cacheInterceptor")注解
 */
...
public @interface Cache {
	...
	/**
	 * 指明缓存超时时间(秒)，超过这个时间该缓存将被删除。如果超时时间小于等于0，则为永久缓存。 缺省则使用配置文件中所配置的超时时间
	 * 
	 * @return
	 */
	...
	/**
	 * 指明CacheType为有序集类型时，往缓存中存放list时，是否倒转原有顺序。 缺省不倒转
	 * 
	 * @return
	 */
