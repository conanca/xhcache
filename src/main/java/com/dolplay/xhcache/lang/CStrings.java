...
public class CStrings {
	 ...
	 * @return
	 */
	public static String cacheKey(String cacheKeyPrefix,
			String... cacheKeySuffixs) {
	 ...
	 * @return
	 */
	public static String commonCacheKey(String cacheKeyPrefix,
			Object... cacheKeySuffixs) {
		StringBuilder sb = new StringBuilder(cacheKeyPrefix);
		if (cacheKeySuffixs != null && cacheKeySuffixs.length > 0) {
			for (Object cacheKeySuffix : cacheKeySuffixs) {
				...
				if (cacheKeySuffix == null) {
					cacheKeySuffix = "";
				} else if (CharSequence.class.isAssignableFrom(cacheKeySuffix
						.getClass())) {
					cacheKeySuffix = cacheKeySuffix.toString();
				} else {
					cacheKeySuffix = JSON.toJSONString(cacheKeySuffix,
